...
export default NewAccountOnboarding = () => {
  ...
  beforeAll(async () => {
    ...
    await launchApp({
      ...
      launchArgs: {
        onboardingOverrides: 'EnableBiometry,ProtectWallet,PhoneVerification',
      },
    })
    await sleep(5000)
  })
  ...
  it('Should be able to restore newly created account', async () => {
    ...
    await launchApp({
      ...
      launchArgs: {
        onboardingOverrides:
          'EnableBiometry,ProtectWallet,PhoneVerification,CloudBackup,CloudBackupSetupInOnboarding',
      },
    })
