...
describe('DappScreen', () => {
  ...
  it('renders correctly and fires the correct actions on press dapp', () => {
    const { getByText, queryByText } = render(
      <Provider store={defaultStore}>
        <MockedNavigator component={DappScreen} />
      </Provider>
    )
  ...
  it('renders error message when fetching dapps fails', () => {
    ...
    // crash in the app
    expect(getByTestId('DappScreen')).not.toHaveTextContent('0')
  })
  ...
  describe('favorite dapps', () => {
    ...
    it('renders correctly when there are favourited dapps', () => {
      ...
      const favoritesSectionResults = getAllByTestId('DappScreen/FavoritesSection/DappCard')
    ...
    it('triggers the events when favoriting', () => {
      ...
      const allDappsSection = getByTestId('DappScreen/DappsList')
  ...
  describe('searching dapps', () => {
    it('renders correctly when there are no search results', () => {
      ...
      expect(queryByTestId('DappScreen/FavoritesSection/NoResults')).toBeNull()
      expect(getByTestId('DappScreen/AllSection/NoResults')).toBeTruthy()
    })
    ...
    it('renders correctly when there are search results in both sections', () => {
      ...
      const allSectionResults = getAllByTestId('DappScreen/AllSection/DappCard')
      ...
      expect(queryByTestId('DappScreen/FavoritesSection/NoResults')).toBeNull()
      expect(queryByTestId('DappScreen/AllSection/NoResults')).toBeNull()
    })
  ...
  describe('filter dapps', () => {
    ...
    it('renders correctly when there are filters applied', () => {
      ...
      expect(queryByTestId('DappScreen/FavoritesSection/DappCard')).toBeNull()
    ...
    it('triggers event when clearing filters from category section', () => {
      ...
      fireEvent.press(getByTestId('DappScreen/AllSection/NoResults/RemoveFilter'))
    ...
    it('triggers event when clearing filters from favorite section', () => {
      ...
      expect(queryByTestId('DappScreen/FavoritesSection/Title')).toBeNull()
      expect(queryByTestId('DappScreen/FavoritesSection/DappCard')).toBeNull()
  ...
  describe('searching and filtering', () => {
    ...
    it('renders correctly when there are results in favorites and no results in all', () => {
      ...
      expect(queryByTestId('DappScreen/AllSection/DappCard')).toBeFalsy()
      expect(getByTestId('DappScreen/AllSection/NoResults')).toBeTruthy()
    })
  ...
  describe('dapp open analytics event properties', () => {
    ...
    it('should dispatch with filter and search', () => {
      ...
      expect(getAllByTestId('DappScreen/AllSection/DappCard')).toHaveLength(1)
      fireEvent.press(getByText('Dapp 3'))
