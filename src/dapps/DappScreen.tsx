...
type Props = NativeStackScreenProps<StackParamList, Screens.DappScreen>

function DappScreen({ navigation }: Props) {
        ...
        ? [
            {
              ...
              testID: 'DappScreen/FavoritesSection',
            },
          ]
        : []),
      {
  ...
  return (
    <SafeAreaView testID="DappScreen" style={styles.safeAreaContainer} edges={[]}>
      <>
        {!loading && !!error && (
