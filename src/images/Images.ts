...
export const whiteProgressBig = require('src/images/white-progress-big.png')
...
export const dappListLogo = require('src/images/dapp-list-logo.png')
...
export const leaves = require('src/images/leaves.png')
...
export const ecosystem = require('src/images/Ecosystem.png')
export const innovation = require('src/images/Innovation.png')
export const kolektivoGeneral = require('src/images/Kolektivo-General.png')
export const culture = require('src/images/Culture.png')
export const governance = require('src/images/Governance.png')
export const leadership = require('src/images/Leadership.png')
export const animatedQrScan = require('src/images/scan-qr-code.gif')
export const educationMpc1 = require('src/images/education-mpc-1.png')
export const educationMpc2 = require('src/images/education-mpc-2.png')
export const manageMpc = require('src/images/manage-mpc.png')
export const manageMigrate = require('src/images/manage-migrate.png')
export const manageRefresh = require('src/images/manage-refresh.png')
export const migrateAbout = require('src/images/migrate-about.png')
export const migrateExport = require('src/images/migrate-export.png')
export const migrateImport = require('src/images/migrate-import.png')
export const recoveryEmail = require('src/images/recovery-email.png')
export const compromisedAccount = require('src/images/compromised-account.png')
export const verificationCode = require('src/images/verification-code.png')
