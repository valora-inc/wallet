...
describe('SendRedesign', () => {
  ...
  it('emits event when invite button is pressed', async () => {
    ...
    expect(ValoraAnalytics.track).toHaveBeenCalledWith(SendEvents.send_redesign_invite)
  })
  it('navigates to QR screen when QR button is pressed', async () => {
    ...
    expect(ValoraAnalytics.track).toHaveBeenCalledWith(SendEvents.send_redesign_scan_qr)
