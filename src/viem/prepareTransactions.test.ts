  ...
  describe('prepareTransactions function', () => {
    ...
    it("returns a 'possible' result when spending the max balance of a feeCurrency when there's another feeCurrency to pay for the fee", async () => {
      ...
      const feeCurrencies = [
        ...
        {
          ...mockFeeCurrencies[1],
          balance: new BigNumber(101_000), // total gas needed is 100.6k units
          decimals: 3,
        },
      ]
        ...
        baseTransactions: [
          {
            ...
            to: '0xto' as Address,
            data: '0xdata',
            // mock estimateGas returns 500, 50k units added for non-native fee currency
          },
          {
            from: '0xfrom' as Address,
            to: '0xto' as Address,
      ...
      expect(result).toStrictEqual({
        ...
        transactions: [
          {
            ...
            maxFeePerGas: BigInt(1),
            maxPriorityFeePerGas: BigInt(2),
            feeCurrency: feeCurrencies[1].address,
          },
          {
            from: '0xfrom',
            to: '0xto',
        ...
        maxGasFeeInDecimal: new BigNumber('100.6'),
        feeCurrency: feeCurrencies[1],
      })
    })
