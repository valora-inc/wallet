export interface OnboardingExperimentParams {
  disableForcedBackup: boolean // Whether to disable forced 24h backup.
  showRecoveryPhraseInOnboarding: boolean // Whether to show recovery phrase and backup options in onboarding.
  showCloudBackupFakeDoor: boolean // Whether to show cloud backup as a fakedoor recovery option. No effect if showRecoveryPhraseInOnboarding is false.
