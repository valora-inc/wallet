...
const getAccountNumberSchema = (implicitParams: {
  ...
  // TODO: Save accountName as last 4 digits of accountNumber https://linear.app/valora/issue/ACT-317/remove-account-name-from-bank-account-info-withdraw-flow
