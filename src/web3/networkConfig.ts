...
const QUOTE_PRICE_URL = 'https://celo.api.0x.org/swap/v1/price?'
const QUOTE_SWAP_URL = 'https://celo.api.0x.org/swap/v1/quote?'
...
const networkConfigs: { [testnet: string]: NetworkConfig } = {
  [Testnets.alfajores]: {
    ...
    priceSwapUrl: QUOTE_PRICE_URL,
    quoteSwapUrl: QUOTE_SWAP_URL,
  },
  [Testnets.mainnet]: {
    networkId: '42220',
