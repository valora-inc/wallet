...
export enum JumpstartEvents {
  ...
  jumpstart_send_start = 'jumpstart_send_amount_start',
  jumpstart_send_succeeded = 'jumpstart_send_amount_succeeded',
  jumpstart_send_failed = 'jumpstart_send_amount_failed',
  jumpstart_send_cancelled = 'jumpstart_send_amount_cancelled',
