...
export enum EarnEvents {
  ...
  earn_claim_submit_start = 'earn_claim_submit_start',
  earn_claim_submit_success = 'earn_claim_submit_success',
  earn_claim_submit_error = 'earn_claim_submit_error',
  earn_claim_submit_cancel = 'earn_claim_submit_cancel',
