...
export enum JumpstartEvents {
  ...
  jumpstart_share_screen_share_link = 'jumpstart_share_screen_share_link',
  jumpstart_share_screen_share_via_QR = 'jumpstart_share_screen_share_via_QR',
  jumpstart_share_screen_copy_link = 'jumpstart_share_screen_copy_link',
  jumpstart_share_screen_close = 'jumpstart_share_screen_close',
  jumpstart_share_screen_confirm_close = 'jumpstart_share_screen_confirm_close',
  jumpstart_share_screen_dismiss_close = 'jumpstart_share_screen_dismiss_close',
