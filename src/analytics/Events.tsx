...
export enum KeylessBackupEvents {
  ...
  cab_restore_progress_failed_try_again = 'cab_restore_progress_failed_try_again',
  cab_restore_progress_failed_create_new_wallet = 'cab_restore_progress_failed_create_new_wallet',
  cab_restore_progress_failed_help = 'cab_restore_progress_failed_help',
}
