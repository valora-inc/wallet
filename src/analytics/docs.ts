...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [EarnEvents.earn_claim_submit_start]: `When the wallet is about to submit the claim transactions to the network`,
  [EarnEvents.earn_claim_submit_success]: `When the claim transactions succeed`,
  [EarnEvents.earn_claim_submit_error]: `When the claim transactions fail`,
  [EarnEvents.earn_claim_submit_cancel]: `When the user cancels the claim transactions after submitting by cancelling PIN input`,
