...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [AssetsEvents.tap_import_token_screen_open]: `When a user taps on the "Import" top bar button in the Assets screen`,
  [AssetsEvents.tap_import_token_action]: `When a user taps on the "Import" button in the Import Token screen`,
  [AssetsEvents.tap_import_token_paste]: `When a user taps on the "Paste" button in the Import Token screen`,
