...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [JumpstartEvents.send_amount_exceeds_allowed_threshold]: `When the user enters a send value greater than allowed threshold, and is shown the max send amount warning`,
