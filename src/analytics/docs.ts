...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [AppEvents.account_funded]: `0.01 USD threshold`,
  [AppEvents.account_liquidated]: `User balance (total fiat value of all supported tokens) falls below $0.01 USD and in a previous app session the value was greater than this`,
