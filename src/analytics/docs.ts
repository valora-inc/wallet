...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [KeylessBackupEvents.cab_sign_in_screen_back]: `When the back button is pressed on the sign in with email screen`,
  [KeylessBackupEvents.cab_sign_in_screen_cancel]: ``,
  [KeylessBackupEvents.cab_sign_in_screen_skip]: `When the skip button is pressed on the sign in with email bottom sheet`,
