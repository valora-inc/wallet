...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [KeylessBackupEvents.cab_setup_continue]: `When the continue button is pressed in the setup wallet backup screen`,
  ...
  [KeylessBackupEvents.cab_restore_progress_failed_try_again]: `When a user is restoring from CAB and the restore fails, and they opt to try again`,
  [KeylessBackupEvents.cab_restore_progress_failed_create_new_wallet]: `When a user is restoring from CAB and the restore fails, and they opt to create a new wallet`,
  [KeylessBackupEvents.cab_restore_progress_failed_help]: `When a user is restoring from CAB and the restore fails, and they press the Help button`,
