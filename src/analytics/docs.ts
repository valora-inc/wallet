...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [AppEvents.account_funded]: `When a user's balance has changed from below 1 cent (USD) to above. User must enter app for this to get published (like all events in this file).`,
  [AppEvents.account_liquidated]: `When a user's balance changes from above 1 cent (USD) to below. User must enter app for this to get published (like all events in this file).`,
