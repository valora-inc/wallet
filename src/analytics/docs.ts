...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [EarnEvents.earn_multi_pool_add_to_pool_press]: `When the user taps 'Add to pool' on a pool card`,
  [EarnEvents.earn_multi_pool_exit_pool_press]: `When the user taps 'Exit pool' on a pool card`,
