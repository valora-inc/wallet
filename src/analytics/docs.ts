...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [KeylessBackupEvents.cab_sign_in_with_email_start]: `When the user presses 'Sign in with Apple' or 'Sign in with Google'`,
  [KeylessBackupEvents.cab_sign_in_with_email_success]: `When the user has successfully signed in with google or apple`,
