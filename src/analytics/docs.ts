...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [OnboardingEvents.link_phone_number]: `User chooses to link phone number after recovery flow`,
  [OnboardingEvents.link_phone_number_later]: `User chooses not to link phone number after recovery flow`,
