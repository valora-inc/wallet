...
export const eventDocs: Record<AnalyticsEventType, string> = {
  ...
  [KeylessBackupEvents.cab_setup_hashed_keyshare_phone]: `When a user is setting up CAB, the hashed keyshare from their phone is saved`,
  [KeylessBackupEvents.cab_setup_hashed_keyshare_email]: `When a user is setting up CAB, the hashed keyshare from their email is saved`,
