...
export function FavoriteDappsSectionV2({ onPressDapp, filter, removeFilter }: Props) {
  ...
  return <NoResults filter={filter} removeFilter={removeFilter} />
}
...
export default FavoriteDappsSectionV2
