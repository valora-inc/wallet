...
describe.each([{ isTabNavigator: false }, { isTabNavigator: true }, {}])(
  'DAppsExplorerScreenSearchFilter (isTabNavigator: $isTabNavigator)',
  (routeParams) => {
    beforeEach(() => {
    ...
    it('renders correctly and fires the correct actions on press dapp', () => {
      const { getByText, queryByText, getByTestId, queryByTestId } = render(
        <Provider store={defaultStore}>
          <MockedNavigator component={DAppsExplorerScreenSearchFilter} params={routeParams} />
        </Provider>
      )
...
//       <Provider store={defaultStore}>
//         <MockedNavigator component={DAppsExplorerScreenSearchFilter} params={{}} />
//       </Provider>
//     )
