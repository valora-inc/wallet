...
export const MOONPAY_SECRET_KEY_STAGING =
  (process.env.MOONPAY_SECRET_KEY_STAGING as string) || config.moonpay.secret_key_staging // config.moonpay used when deployed to celo-testnet-production
...
export const MOONPAY_SECRET_KEY_PROD =
  (process.env.MOONPAY_SECRET_KEY_PROD as string) || config.envs.secret_key_prod // config.envs used when deployed to celo-mobile-mainnet
