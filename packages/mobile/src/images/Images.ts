...
export const valoraTokenNotification = require('src/images/Tokens.png')
export const celoNotification = require('src/images/celo-notification.png')
export const gotValoraTokens = require('src/images/Valora-general-illustrations-30.png')
