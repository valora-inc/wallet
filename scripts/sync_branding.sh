...
if [[ "$branding" == "valora" ]]; then
  ...
  if [[ ! -e branding/valora ]] && 
    ( 
      ! git clone git@github.com:valora-inc/valora-app-branding.git branding/valora ||
      ! git clone https://github.com/valora-inc/valora-app-branding.git branding/valora 
    ); then
